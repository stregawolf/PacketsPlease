 ...
 */
public class RuleData : IComparable {
    ...
    public int CompareTo(RuleData other)
    {
    ...
    public override void ToString()
    {
        ...
        m_priority, m_correctActionType, m_dataUsage, m_daysActive, m_activityName, m_activityType, m_customerName);
    }
}
