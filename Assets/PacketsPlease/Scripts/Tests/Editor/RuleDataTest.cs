...
public class RuleDataTest {
    ...
    [SetUp]
    public void Setup() {
        GameObject ruleManagerObj = Instantiate();
    ...
    public void AddRulesAndClearThem() {
        RuleData testRule = new RuleData(0, ActionType.Throttle);
    ...
    {
        CustomerData c = ScriptableObject.CreateInstance();
    ...
    public void BlanketRuleAppliesToEveryone() {
        ...
        RuleData throttleEveryone = new RuleData(RuleData.HIGHEST_PRIORITY, ActionType.Throttle);
        ruleManager.ClearAllRules();
    ...
    public void ThrottleAbove50() {
        ...
        RuleData throttleAbove50 = new UsageHigherRule(50f, RuleData.HIGHEST_PRIORITY, ActionType.Throttle);
        ruleManager.ClearAllRules();
    ...
    public void ThrottleAboveBoostBelow50() {
        ...
        RuleData throttleAbove50 = new UsageHigherRule(50f, RuleData.HIGHEST_PRIORITY, ActionType.Throttle);
        RuleData boostBelow50 = new UsageLowerRule(50f, RuleData.HIGHEST_PRIORITY, ActionType.Boost);
        ruleManager.ClearAllRules();
        ruleManager.AddRule(throttleAbove50);
        ...
        for(int i = 0; i < RANDOM_TEST_ITERATIONS; i++)
        {
            ...
            {
                AssertValidActionIs(RuleManager.Boost, c);
            }
        }
    }
